    ...
    <div class="surface-ground px-4 md:px-6 lg:px-8">
        <div class="p-fluid flex flex-column lg:flex-row">
            <div class="surface-card p-5 shadow-2 border-round flex-auto">
                <div class="text-900 font-semibold text-lg mt-3">User profile for {{ user.props?.displayName }}</div>
                ...
                <div class="flex gap-5 flex-column-reverse md:flex-row">
                    ...
                    <div class="flex flex-column align-items-center flex-or">
                        <Avatar :image="user.props?.avatarUrl" alt="user avatar" class="h-10rem w-10rem" shape="circle" />
                    </div>
                </div>
            </div>
        </div>
