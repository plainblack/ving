                    ...
                    <Menu as="div" class="relative ml-3">
                        <div>
                            <MenuButton v-if="currentUserStore.currentUser"
                                ...
                                <img class="h-8 w-8 rounded-full" :src="currentUserStore.currentUser.props.avatarUrl"
                                    alt="user avatar" />
                        ...
                        <transition enter-active-class="transition ease-out duration-100"
                            ...
                            <MenuItems
                                ...
                                <NuxtLink :href="'/user/profile/' + currentUserStore.currentUser?.props.displayName"
                                    @mouseup="close"
            ...
            <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
                ...
                <form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
                    ...
                    <div class="mt-4 sm:mt-0 sm:ml-4 sm:flex-shrink-0">
                        <button type="submit"
                            class="flex w-full items-center justify-center rounded-md bg-indigo-500 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Subscribe</button>
                    </div>
                </form>
            </div>
            <div class="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
                <div class="flex space-x-6 md:order-2">
                    <a v-for="item in footNav.social" :key="item.name" :href="item.href"
                        class="text-gray-500 hover:text-gray-400">
                        <span class="sr-only">{{ item.name }}</span>
                        <component :is="item.icon" class="h-6 w-6" aria-hidden="true" />
                    </a>
                </div>
                <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">&copy; 2023 {{ config.public.companyName
                }}.
                    All rights
                    reserved.</p>
            </div>
